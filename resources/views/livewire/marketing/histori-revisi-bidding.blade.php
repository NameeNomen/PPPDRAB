        ...
        <div class="print:hidden p-6 rounded-2xl shadow-xl border-2 border-[#E5E5E5] bg-white flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
            ...
            <div class="relative z-10 flex-grow">
                ...
                <p class="text-xs mt-1 font-medium text-[#888888]">
                    {{ $view === 'project-list' ? 'Lacak rekam jejak, revisi, dan perubahan nilai penawaran setiap versi dokumen.'
                    : 'Rekapitulasi perubahan pada dokumen bidding proyek terkait.' }}
                </p>
            </div>

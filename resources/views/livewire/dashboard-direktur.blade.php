        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
            <div class="lg:col-span-2 bg-white p-6 md:p-8 rounded-2xl border border-[#E2E8F0] shadow-sm">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-xs font-black uppercase tracking-widest text-[#0F172A]">Analisis Tren Proyek & Omzet</h2>
                    <span class="text-[10px] font-bold px-3 py-1 bg-[#EEF2FF] rounded-md text-[#4F46E5] border border-[#C7D2FE]">Bulan Ini</span>
                </div>
                <div class="h-[250px] flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-[#CBD5E1] bg-[#F8FAFC] transition-colors hover:bg-[#F1F5F9]">
                    <svg class="w-8 h-8 mb-3 text-[#94A3B8]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"></path></svg>
                    <span class="text-[#64748B] text-xs font-bold uppercase tracking-widest">[ Ruang Integrasi Chart.js ]</span>
                </div>
            </div>
            ...
            <div class="bg-white p-6 md:p-8 rounded-2xl border border-[#E2E8F0] shadow-sm">
                ...
                <div class="space-y-4">
                    ...
                    @empty
                        <div class="py-8 text-center text-xs font-medium text-[#94A3B8]">Belum ada proyek terdaftar.</div>
                    @endforelse
                </div>
            </div>
        </div>
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    @if($antrianApproval->count() > 0)
                        <span class="flex h-3 w-3 relative">
                            ...
                            <span class="relative inline-flex rounded-full h-3 w-3 bg-[#4F46E5]"></span>
                        </span>
                    @endif
                </div>
                <div class="space-y-4">
                    @forelse($antrianApproval as $item)
                        <div class="flex justify-between items-center p-5 rounded-xl border border-[#E2E8F0] bg-white hover:border-[#818CF8]/50 hover:bg-[#F8FAFC] shadow-sm hover:shadow-md transition-all group">
                            <div>
                            ...
                            <a href="/direktur/persetujuan" class="bg-[#1E1B4B] hover:bg-[#312E81] text-white text-[10px] font-black uppercase tracking-widest px-5 py-2.5 rounded-lg transition-all hover:-translate-y-0.5 shadow-sm">
                                TINJAU
                            </a>
                        </div>
                    @empty
                        ...
                        <div class="relative pl-6">
                            ...
                            <div class="bg-[#F8FAFC] p-4 rounded-xl border border-[#E2E8F0]">
                                <div class="flex justify-between items-start mb-1">
                                    ...
                                    <span class="text-[9px] font-bold font-mono text-[#64748B]">
